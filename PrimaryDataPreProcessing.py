...
print("Removing quotation marks at ends")
print(" ")
...
print("Calculating the number of unique words")
print(" ")
...
print("Eliminating Excessive words")
print(" ")
...
print("Creating simplified sentences with only useful words")
print(" ")
...
print("Exporting processed data for further use")
print(" ")
...
print("Complete! Now use RandomForest.py to establish a baseline")